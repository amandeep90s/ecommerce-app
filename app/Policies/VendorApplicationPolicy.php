...
class VendorApplicationPolicy
{
     ...
     */
    public function restore(User $user, VendorApplication $vendorApplication): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, VendorApplication $vendorApplication): bool
    {
        return false;
    }
}
